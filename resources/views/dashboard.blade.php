        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center">
                                        <div class="w-32 bg-gray-200 rounded-full h-2 mr-3">
                                            <div class="bg-blue-600 h-2 rounded-full" style="width: {{ ($count / $totalEmployees) * 100 }}%"></div>
                                        </div>
            ...
            <div class="mt-8 bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <a href="{{ route('employees.index') }}" class="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-150">
                    ...
                    <a href="{{ route('conges.index') }}" class="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-150">
                        <div class="text-center">
                            ...
                            <span class="text-sm font-medium text-gray-700">Leave Requests</span>
                        </div>
                    </a>
                    <a href="{{ route('evaluations.index') }}" class="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-150">
                        <div class="text-center">
                            <svg class="h-8 w-8 mx-auto text-green-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-sm font-medium text-gray-700">Evaluations</span>
                        </div>
                    </a>
                    <a href="{{ route('employees.create') }}" class="flex items-center justify-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-150">
                        <div class="text-center">
                            <svg class="h-8 w-8 mx-auto text-indigo-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
