                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div class="text-center">
                        ...
                        <p class="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
                            A simple, professional CRM to manage employees, leave requests, and performance evaluations.
                        </p>
                    ...
                    <div class="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="card p-6">
                            ...
                            <h3 class="text-lg font-semibold text-slate-900 mb-2">Employee Management</h3>
                            <p class="text-slate-600">Track employee information, departments, positions, and hire dates in one central place.</p>
                        </div>
                        ...
                        <div class="card p-6">
                            ...
                            <h3 class="text-lg font-semibold text-slate-900 mb-2">Leave Requests</h3>
                            <p class="text-slate-600">Submit and manage leave requests with clear approval workflows.</p>
                        </div>
                        ...
                        <div class="card p-6">
                            ...
                            <h3 class="text-lg font-semibold text-slate-900 mb-2">Performance Evaluations</h3>
                            <p class="text-slate-600">Run structured performance reviews with scoring and feedback.</p>
                        </div>
                    </div>
                        ...
                        <div class="p-6 bg-gray-50">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                ...
                                <div class="p-4 bg-white rounded-lg border border-slate-200">
                                    ...
                                    <div class="text-2xl font-bold text-slate-900">4.2/5</div>
                                </div>
                            </div>
                            <div class="bg-white rounded-lg p-4 border border-slate-200 h-32 flex items-center justify-center text-slate-400">
                                Dashboard Preview
                            </div>
                        </div>
                    </div>
